...
export default function Services() {
  ...
  return <div className="site-shell"><Header /><main>
    <PageHero eyebrow="SERVICES + COVERAGE" title="Useful help starts with a clear boundary." copy="We handle heating, cooling, and plumbing across the core Greater Providence area—with a booking path that distinguishes urgent from planned work." image="/manus-storage/anchor-van-route_2a2eaf74.jpg"><Link href="/book" className="button">Book a service <ArrowUpRight size={16} /></Link></PageHero>
